...
foo1(a);
console.log(a);//123  基本数据类型-值赋值-不改变之前的值
...
console.log(a.y);//345  引用数据类型-引用赋值-改变之前的值
...
foo3(a);
console.log(a.y);//345  引用数据类型-引用赋值-改变之前的值，改变整个对象-不改变之前的值
...
foo4(a);
console.log(a.y);//123  改变整个对象-不改变之前的值，对x进行引用赋值-改变x的值
