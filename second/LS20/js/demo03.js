...
// \d匹配任一个阿拉伯数字
var reg4=/a\dc/gi;
var str2='a2c a3c abc';
console.log(str2.match(reg4));//a2c a3c

//\D匹配任意一个不是阿拉伯数字的字符
var reg4_2=/a\Dc/gi;
var str2='a2c a3c abc';
console.log(str2.match(reg4-2));//abc

/*
    [xyz]从中括号的字符集合中任取一个字符
    [^xyz]排除中括号字符集合中的字符
 */
var str = "atf btf ktf";
var reg = /[^abc]tf/gi;
...
//test方法测试当前正则是否能匹配目标字符串。
var reg2 = /0-9z$/gi;
var str2 = "abcd9z";
var str2_2 = "bcfbdfdfd9";
console.log(reg2.test(str2));//false
console.log(reg2.test(str2_2));//false
