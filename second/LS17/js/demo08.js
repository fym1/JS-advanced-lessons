...
/*
    person name属性Mike、person._proto_.age、person._proto_.showName
 */
Student.prototype = new Person("Mike");//*给Student的原型上赋了一个Person实例化的对象
var s1 = new Student(2017001);
var s2 = new Student(2017002);

//测试如下代码，思考为什么，这样的继承有什么弊端
/*
    s1自身上面没有age，s1_proto_ == Student.prototype
    Student.prototype = new Person("Mike");  new Person("Mike")（用person代替）上面没有age属性
