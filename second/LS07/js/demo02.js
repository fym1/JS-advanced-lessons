...
obj.test();//调用对象的方法23 {name: "obj", x: 23, test: ƒ}
...
//两层嵌套，对象中的方法嵌套两层及以上this的指向会变成windows
var x = 45;
var obj = {
    x:23,
    test:function(){
...
fn.call(null, 'Skylor', 'min');        //window 'Skylor'  'min'
fn.call(undefined, 'Skylor', 'min');   //window 'Skylor'  'min'

var fx = function() {}

fn.call(fx, 'Skylor', 'min');          //fx  'Skylor'  'min'
